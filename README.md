...
<h3 align="center">MERN Stack Developer | Next.js & TypeScript Learner | Java Programmer | GATE(CS) 2025 Qualified - Rank 451</h3>
...
-  **Languages**: C, C++, Java (JSP, JavaFX, JDBC), Python, SQL
...
- **StudyNotion EdTech Platform** – Full-stack learning platform with course creation, enrollment, role-based dashboards, authentication, and secure payment workflow.  
  ...
  ![Razorpay](https://img.shields.io/badge/Razorpay-0C9CEE?logoColor=white) 
...
- **Game Galaxy** – Desktop gaming suite with multiplayer & single-player games and MySQL score tracking.  
